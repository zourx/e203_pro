...
//////////*******************************************////////////     
`define E203_NTS_ADDR_BASE `E203_CFG_NTS_BASE
//////////*******************************************////////////           
...
//////////*******************************************////////////
//////////*******************************************////////////
/////// nest_trap_stack relevant macro

`ifdef E203_CFG_HAS_NTS//{
  `define E203_HAS_NTS 1
  `define E203_NTS_ADDR_WIDTH  `E203_CFG_NTS_ADDR_WIDTH

  // The nest_trap_stack size is 2^addr_width bytes
  // and nest_trap_stack is 32bits wide (4 bytes)
  //  so the DP is 2^addr_wdith/4
  //  so the AW is addr_wdith - 2
  
  `define E203_NTS_RAM_DP      (1<<(`E203_CFG_NTS_ADDR_WIDTH-2)) 
  `define E203_NTS_RAM_AW          (`E203_CFG_NTS_ADDR_WIDTH-2) 
  `define E203_NTS_BASE_REGION `E203_ADDR_SIZE-1:`E203_NTS_ADDR_WIDTH
  
    // `define E203_NTS_DATA_WIDTH  32
    `define E203_NTS_WMSK_WIDTH  20
//
  `ifndef E203_HAS_ECC //{
//    `define E203_NTS_RAM_DW32      `E203_NTS_DATA_WIDTH
    `define E203_NTS_RAM_DW         640
//    `define E203_NTS_RAM_DWreg      640 // 32*20
    `define E203_NTS_RAM_MW        `E203_NTS_WMSK_WIDTH
    `define E203_NTS_OUTS_NUM 1 // If no-ECC, NTS is 1 cycle latency then only allow 1 oustanding for external agent
  `endif//}
//
  `define E203_HAS_NTS_EXTITF
`endif//}
